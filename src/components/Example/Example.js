...
import { option1, option2, option3 } from '../../constants/Constants'; 
        ...
        try {
          axios.request(option1).then(function (response) {
            const cardItem = {
                ...
                followers: response.data.social_followers,
            };
            setAddCard(card => [...card, cardItem]);
          })
          axios.request(option2).then(function (response) {
            const cardItem = {
                id: response.data.profile_id,
                name: response.data.company_name,
                image: response.data.image_url,
          ...
          axios.request(option3).then(function (response) {
            const cardItem = {
                id: response.data.profile_id,
                name: response.data.company_name,
                image: response.data.image_url,
